...
class Client extends discord_js_1.Client {
    ...
    init(token, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.rest = new discord_js_1.REST({ version: options.version });
            ...
            this.once("ready", (client) => __awaiter(this, void 0, void 0, function* () {
                if (this.commands.size && options.restart)
    ...
    getCommand(command, subcommand, group) {
        var _a;
        if (!group)
            return this.subcommands.get(`${command}-${subcommand}`);
        else
            return (_a = this.subcommands.get(`${command}-${group}-${subcommand}`)) !== null && _a !== void 0 ? _a : this.subcommands.get(`${command}-${subcommand}`);
    }
    ...
    loadSlashCommands() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.rest.put(discord_js_1.Routes.applicationCommands(this.user.id), { body: commands });
