...
class Client extends discord_js_1.Client {
    ...
    init(token, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield this.register((_b = (_a = options.directories) === null || _a === void 0 ? void 0 : _a.commands) !== null && _b !== void 0 ? _b : "./commands");
            yield this.register((_d = (_c = options.directories) === null || _c === void 0 ? void 0 : _c.events) !== null && _d !== void 0 ? _d : "./events");
            ...
            const processFile = (file) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (stats.isDirectory())
                    ...
                    if (data instanceof command_1.default)
                        ...
                        this.subcommands.set(`${data.command}${data.subcommandGroup ? `-${data.subcommandGroup}` : ""}-${data.subcommand}`, data);
